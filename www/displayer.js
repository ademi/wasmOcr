class Displayer{
  init(payload){
    main(payload.data, payload.width,payload.height);
  }
}
...
// Start here
//
function main(rgba_buffer,width,height) {
  ...
  const texture = loadTexture(gl, rgba_buffer,width,height);//'http://localhost:8080/ocr_example.png');
...
//
function loadTexture(gl, rgba_buffer,width,height) {
...
function drawScene(gl, programInfo, buffers, texture, deltaTime) {
  ...
  mat4.translate(modelViewMatrix,     // destination matrix
                 ...
                 [0.5, 0.5, -2.5]);  // amount to translate
